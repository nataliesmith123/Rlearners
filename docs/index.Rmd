...
### June 15 - Data management

The main data management things we will cover by working through some things together
...
+ options for transposing data: `pivot_longer()` and `pivot_wider()`
+ importing and exporting data to a variety of file types/softwares
...
```{r dm_exercises, eval=FALSE, include=FALSE}
```
...
Now we'll dive into some of the nitty gritty of R! Goals for today are 1) understanding 'objects' in R, and 2) beginning data management. 
