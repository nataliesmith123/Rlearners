...
"Getting all the necessary software installed, configured, and playing nicely together is honestly half the battle when first adopting Git. Brace yourself for some pain. The upside is that you can give yourself a pat on the back once you get through this. And you WILL get through this." ~ Jenny Bryan

When in doubt: restart R, uninstall/reinstall programs, walk away for a few mins. 
...
+ R & R Studio basics
    ...
    + Keyboard shortcuts
    + Global and project options -- see Resources for .Rdata suggestions
...
+ See what my general workflow looks like
    ...
    + Folder structure
    + File naming convention (when applicable - show Aim 2 scripts)
    + Show Git/GitHub desktop interface (with R learners )
...
+ Watch it in action
    ...
    3. Creating a repository in R Studio
...
+ Exercises
    + Exercise #1
        + Create an R project from the existing 
    + Exercise #2
